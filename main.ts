...
namespace msmSmartTools {
    ...
    export function mettreAJourCapteursLigne(): void {
        capteur1 = dadabit.line_followers(dadabit.LineFollowerSensors.S1, dadabit.TrackbitType.State_0)
        capteur2 = dadabit.line_followers(dadabit.LineFollowerSensors.S2, dadabit.TrackbitType.State_0)
        capteur3 = dadabit.line_followers(dadabit.LineFollowerSensors.S3, dadabit.TrackbitType.State_0)
        capteur4 = dadabit.line_followers(dadabit.LineFollowerSensors.S4, dadabit.TrackbitType.State_0)
    }
